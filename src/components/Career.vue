    ...
    <div class="career">
      ...
      <div class="career_detail">
        <ul>
          <li>
            <h2>
              K-Car 디자인 개편 프로젝트 (Vue.JS)
              <span>2022.01.06 ~ 2022-04.15 (3.5개월 진행중)</span>
            </h2>
            <ul>
              <li>- 직급 : 선임</li>
              <li>- 담당업무 :</li>
              <li class="subs">Vue.js(Nuxt.js 사용)로 퍼블리싱 진행</li>
              <li class="subs">디자인 프레임워크(Element-ui) 적용 </li>
            </ul>
          </li>
          <li>
            <h2>
              다부처 문화공공데이터광장 구축
              <span>2021.10.01 ~ 2021-12.31 (2개월)</span>
            </h2>
            <ul>
              <li>- 직급 : 과장</li>
              <li>- 담당업무 :</li>
          ...
          <li>
            <h2>
              한화리조트 로컬라이브 구축
              <span>2021.08.09 ~ 2021-09.31 (2개월)</span>
            </h2>
            <ul>
              <li>- 직급 : 과장</li>
              <li>- 담당업무 :</li>
